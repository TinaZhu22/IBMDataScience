...
##Generate confusion matrix for KNN and plot it
...
##This tells GridSearch to try PCA(n_components=2) and PCA(n_components=3)
## This tells GridSearch to try K-Nearest Neighbors with 3, 5, and 7 neighbors.
